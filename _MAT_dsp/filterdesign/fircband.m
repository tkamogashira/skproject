...
%      fvtool(B1,1,B2)
%
%   See also FIRPM, CFIRPM, FIRCEQRIP, FIRLS, FIRGR, IIRLPNORM, 
%   IIRLPNORMC, IIRGRPDELAY, IIRNOTCH, IIRPEAK.

%   Author(s): J. Schickler
%   Copyright 1999-2013 The MathWorks, Inc.

% Suppress the Deprecated Feature warning.
...
try
    ...
    % If FIRGR errors we need to reset the warning states so it looks like
    % it is coming from FIRCBAND.
    [lstr, lid] = lastwarn;
