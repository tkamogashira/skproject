function [num, den, allpassnum, allpassden] = iirlp2bp(b, a, wo, wt)
%IIRLP2BP IIR lowpass to bandpass frequency transformation.
%   [Num,Den,AllpassNum,AllpassDen] = IIRLP2BP(B,A,Wo,Wt) returns numerator
...
%   is given with a numerator specified by B and a denominator specified by A.
%
%   Inputs:
...
%        fvtool(b, a, num, den);
%
%   See also IIRFTRANSF, ALLPASSLP2BP and ZPKLP2BP.
