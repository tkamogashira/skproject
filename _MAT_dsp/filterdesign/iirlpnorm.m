...
%   coefficients in vectors INITNUM and INITDEN respectively. INITNUM and INITDEN
%   must be of length N+1 and D+1 respectively. Specifying initial estimates may be
%   useful for difficult optimization problems. The pole-zero editor in the Signal
