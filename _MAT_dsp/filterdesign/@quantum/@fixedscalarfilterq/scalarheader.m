...
%SCALARHEADER_ORDER0 specifies the blocks, connection and quantization parameters in the
...
%gain
%LHG numerator gain
lgainqparam.qcoeff=[H.CoeffWordLength H.CoeffFracLength];
lgainqparam.qproduct=[H.OutputWordLength H.OutputFracLength];
