...
% LATTICEARFILTER Filter for DFILT.LATTICEAR class in fixed-point mode
...
% Call DLL
filatticearfilter(coeffStruct,zi,mathStruct,x,y);
...
if isloggingon(q),
    ...
    [prodlog, outlog, acclog, statelog] = ...
        getlogar(q,coeffStruct.lattice,coeffStruct.conjlattice,y,...
