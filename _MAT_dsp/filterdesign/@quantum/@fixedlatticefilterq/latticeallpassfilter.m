...
% LATTICEALLPASSFILTER Filter for DFILT.LATTICEALLPASS class in fixed-point mode
...
% Call DLL
filatticeallpassfilter(coeffStruct,zi,mathStruct,x,y);
...
if isloggingon(q),
    ...
    [prodlog, outlog, acclog, statelog] = ...
        getlogallpass(q,coeffStruct.lattice,coeffStruct.conjlattice,y,...
