...
nstateprop = {'NumStateWordLength';'NumStateFracLength'};
dstateprop = {'DenStateWordLength';'DenStateFracLength'};
...
siguddutils('dispstr', this, {coeffprop, inprop, outprop, nstateprop, ...
    dstateprop, prodprop, accprop, modes}, varargin{:});
