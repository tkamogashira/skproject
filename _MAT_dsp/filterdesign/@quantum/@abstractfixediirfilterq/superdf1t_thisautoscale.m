function superdf1t_thisautoscale(this,s,binptaligned)
%SUPERDF1T_THISAUTOSCALE   
...
nfpprodfl = this.MultiplicandFracLength+this.NumFracLength;
...
dfpprodfl = this.MultiplicandFracLength+this.DenFracLength;
