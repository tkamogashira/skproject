function [NL, NextIPorts, NextOPorts, mainparams]=df2tsosheadconnect(q,NL,H,mainparams)
...
%Replace 1|a(1) with convert block since a(1)=1 in fixed point mode
NL.setnode(filtgraph.node('cast'),5);  %replace the gain with the output cast since in fixed point mode, a(1)=1
