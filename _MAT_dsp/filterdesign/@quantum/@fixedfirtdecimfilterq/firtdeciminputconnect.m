function [NL, NextIPorts, NextOPorts, mainparams]=firtdeciminputconnect(q,NL,H,mainparams,decim_order)

%FIRTDECIMINPUTCONNECT specifies the blocks, connection and quantization parameters in the
