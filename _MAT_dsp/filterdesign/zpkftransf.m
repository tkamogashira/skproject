...
ftransfargchk(z, 'Zeros of the prototype filter', 'vector');
ftransfargchk(p, 'Poles of the prototype filter', 'vector');
ftransfargchk(k, 'Gain of the prototype filter',  'scalar');
...
% Using OR because || doesn't support vectors
if or(ftfnum ~=1, ftfden ~= 1),
