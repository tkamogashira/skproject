function h = swrls(varargin)
%SWRLS  Sliding-window Recursive least-squares FIR adaptive filter.
%   H = ADAPTFILT.SWRLS(L,LAMBDA,INVCOV,SWBLOCKLEN,DSTATES,COEFFS,STATES)
%   constructs an FIR Sliding-window RLS adaptive filter H.
%
...
%   the range (0, 1]. LAMBDA = 1 for a rectangular window.
%   
...
h = adaptfilt.swrls;
construct(h,[0 7],'Sliding-Window RLS FIR Adaptive Filter',varargin{:});
