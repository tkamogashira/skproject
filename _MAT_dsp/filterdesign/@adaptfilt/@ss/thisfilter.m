...
%THISFILTER  Execute sign-sign adaptive filter.
%   Y = THISFILTER(H,X,D) applies a sign-sign adaptive filter H to the input
...
%         communication systems," Bell Systems Technical Journal, 
%         vol. 45, pp. 255-286, Feb. 1966.
...
for n=1:ntr,
    ...
    W = lam*W + mu*sign(e(n))*sX';  %  update filter coefficient vector
end
