function h = tdafdct(varargin)
%TDAFDCT  Transform-domain adaptive filter using discrete cosine transform.
%   H = ADAPTFILT.TDAFDCT(L,STEP,LEAKAGE,OFFSET,DELTA,LAMBDA,COEFFS,
...
%   parameter is set to a value between zero and one, a leaky TDAFDCT
...
h = adaptfilt.tdafdct;
construct(h,[0,8],'Transform-Domain Adaptive Filter using DCT',varargin{:});
