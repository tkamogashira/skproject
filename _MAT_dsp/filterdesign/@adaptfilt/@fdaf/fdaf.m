function h = fdaf(varargin)
%FDAF  Frequency-domain FIR adaptive filter with bin Step size normalization.
%   H = ADAPTFILT.FDAF(L,STEP,LEAKAGE,DELTA,LAMBDA,BLOCKLEN,OFFSET,COEFFS,
%   STATES) constructs a frequency-domain FIR adaptive filter H with bin
...
%   parameter is set to a value between zero and one, a leaky FDAF
...
h = adaptfilt.fdaf;
construct(h,[0,9],'Frequency-Domain FIR Adaptive Filter',varargin{:});
