...
%        % at Wo1=0.2 and Wo2=0.4 to the new bandedges at Wt1=0.3 and Wt2=0.6
%        Wo = [0.2, 0.4];
%        Wt = [0.3, 0.6];
...
allpassnum = fliplr(conj([      alpha -beta] * exp(j*pi*sum(wo)/2)));
allpassden = fliplr(conj([-beta*alpha  1]));
