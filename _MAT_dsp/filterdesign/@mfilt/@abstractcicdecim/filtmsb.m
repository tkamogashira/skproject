function Bmax = filtmsb(this)
%FILTMSB Most significant bit of a CIC decimation filter.
...
%   Gate Arrays, Springer, 2001 

error(message('dsp:mfilt:abstractcicdecim:filtmsb:Obsolete'));
