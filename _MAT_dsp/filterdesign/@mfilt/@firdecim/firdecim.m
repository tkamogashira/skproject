function Hm = firdecim(M,num)
%FIRDECIM Direct-Form FIR Polyphase Decimator.
%   Hm = MFILT.FIRDECIM(M) returns an FIR-based decimator object Hm with an
%   decimation factor of M. A low-pass Nyquist filter of gain 1 and cutoff
%   frequncy of Pi/M is designed by default. This filter allows some
%   aliasing in the transition band but it's been chosen for its efficiency
%   since it's first polyphase component is a pure delay.
%
...
%
%   EXAMPLE: 
%      %Decimation by a factor of 2 (used to convert from 44.1kHz to 22.05kHz)
...
Hm.FilterStructure = 'Direct-Form FIR Polyphase Decimator';
