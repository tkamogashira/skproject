...
ftransfargchk(z, 'Zeros of the filter', 'vector');
ftransfargchk(p, 'Poles of the filter', 'vector');
ftransfargchk(k, 'Gain of the filter',  'scalar');

if nargin == 4,
   ftransfargchk(tol, 'Tolerance factor', 'real', 'positive', 'scalar');
else
   tol = 1e-5;
end;
