...
%
%   EXAMPLE:
%      % Lowpass filter with pole radius constrained to 0.8
%      [b,a,err,s,g] = ...
%         iirlpnormc(6,6,[0 .4 .5 1],[0 .4 .5 1],[1 1 0 0],[1 1 1 1],.8);
%      Hd = dfilt.df1sos(s,g); % Construct a second-order sections filter
