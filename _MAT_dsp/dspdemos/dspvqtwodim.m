...
% --------------------------------------------------------------------
function dspvqtwodim_OpeningFcn(hObject, eventdata, handles, varargin)%#ok
...
function vqplot_training(handles, TS, FirstTime) 
    ...
    if FirstTime, 
		...
		plot(TS(1,:), TS(2,:),'g.','MarkerSize',0.5, 'Tag', 'TSdata');% yellow and only dot; smallest marker size
		xlabel('X-value');              
		ylabel('Y-value');
...
function vqplot_histogram(handles, countTSinCells) 
	 ...
	 for i=1:len % bar returns one handle; but to use mouse down fcn
        ...
        %
        h_bar(i)=bar(i,countTSinCells(i),0.98);
        hold on;
	 end  
...
% --------------------------------------------------------------------
function close_cbs(hcbo, eventstruct, hMainFig)%#ok
% eventstruct  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function printsetup_cbs(hcbo, eventstruct,hMainFig)%#ok
% eventstruct  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function printpreview_cbs(hcbo, eventstruct,hMainFig)%#ok
% eventstruct  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function print_cbs(hcbo, eventstruct,hMainFig)%#ok
% eventstruct  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function fullview_cbs(hcbo, eventstruct, hMainFig)%#ok
% eventstruct  reserved - to be defined in a future version of MATLAB
% Full view analysis
...
% COPY the axes of both the figures.
	...
	h = guidata(hMainFig);
	hFig_printprev = figure('NumberTitle','off',...
                            'visible','off');
...
% --------------------------------------------------------------------
function help_Callback(h, eventdata, handles, varargin)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function varargout = dspvqtwodim_OutputFcn(hObject, eventdata, handles)%#ok
...
% --------------------------------------------------------------------
function editRelTh_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function editMaxIter_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function popupInitCBSource_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function editNumLevel_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function editInitCB_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --------------------------------------------------------------------
function pushbutnStart_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
if (testingvq)
[finalCBmex, ErrArraymex, EntropymexNotUsed]= ...
sdspvqdesignmex(ud.TS, initCodebook, 0, 1, ud.RelTh,ud.MaxIter, 1);%#ok
end
...
while (~halt) 
	...
	ErrArray = [ErrArray Err];%#ok We are not concerned about speed for this demo
	iter = iter + 1;
    if (Err == 0.0) 
       halt = true;
    else
...
if (testingvq)
    if ~isequal(finalCB, finalCBmex) %#ok
        errordlg('test failure finalCB');
    else
        disp('same finalCB');
    end    
    if ~isequal(ErrArraymex, ErrArray') %#ok
...
% --------------------------------------------------------------------
function editTS_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function popupStopCri_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function dspvqtwodim_WindowButtonDownFcn(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
elseif  (xMouse>=HistPos(1) && xMouse<= HistPos(1)+HistPos(3) && ...
      ...
      btype = get(hObject,'SelectionType');
      if (isequal(btype,'alt'))%#ok  % mouse right button pressed 
      	    hHist = handles.plotHistogram;
            hBar = flipud(findobj(hHist,'Tag','Bar'));
...
% --------------------------------------------------------------------
function dspvqtwodim_WindowButtonMotionFcn(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig
...
% --------------------------------------------------------------------
function dspvqtwodim_WindowButtonUpFcn(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig
...
% --------------------------------------------------------------------
function pushbutnStop_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function pushbutnPause_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function pushbutnResume_Callback(hObject, eventdata, handles)%#ok
% eventdata  reserved - to be defined in a future version of MATLAB
% This function is called from dspvqtwodim.fig 
...
% --------------------------------------------------------------------
function h = vqScatter(x,y, sin, cin)  

cax = newplot([]); 
marker = 'o';

color = repmat(cin,length(x),1);
s = repmat(sin,length(x),1); 
scattergroup=1;
