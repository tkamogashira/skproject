...
% This example shows how to use some of the key features of the generalized
% Remez FIR filter design function.  This function provides all the
% functionality included in FIRPM plus many additional features showcased
% here.
%
...
% shows the compatibility of FIRGR with FIRPM.
...
% would use INTFILT(R,L,ALPHA) from the  Signal Processing Toolbox(TM) to do
