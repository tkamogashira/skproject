...
% VQEXPORT MATLAB file for vqexport.fig
...
ud_E.originalParentName = get(ud_E.hMainFigParent,'Name');
...
if (closing_status)
    ...
    %(3) save dirty/clean name of main fig (for cancel button)
...
set(ud_E.hMainFigParent,'Name',ud_E.originalParentName);
set(ud.hTextStatus,'ForeGroundColor','Black'); set(ud.hTextStatus,'String','Ready');
...
% LocalWords:  eventdata ud dialogicons pushbutn applybutn waitstatus
