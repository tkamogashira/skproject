...
variables = {ud.finalCodebook ud.finalPartition ud.errorArray};
...
for i = 1:length(tnames)
    if isvarname(tnames{i}),
        ...
        error(message('dsp:sqaction:invalidVariableName', tnames{ i }));
    end
end
...
variables = {ud.finalCodebook ud.finalPartition ud.errorArray};
labels    = {['Final Codebook'] ['Final Partition'] ['Error']};
