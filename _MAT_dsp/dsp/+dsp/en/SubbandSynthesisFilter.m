classdef SubbandSynthesisFilter< handle
%SubbandSynthesisFilter Reconstruct signal from high-frequency and low-
%                       frequency subbands
%   HSSF = dsp.SubbandSynthesisFilter returns a two-channel subband
%   synthesis filter System object, HSSF, that reconstructs a signal from
%   its high-frequency subband and low-frequency subband, each with half
%   the bandwidth of the original signal.
%
%   HSSF = dsp.SubbandSynthesisFilter('PropertyName', PropertyValue, ...)
%   returns a two-channel subband synthesis filter System object, HSSF,
%   with each specified property set to the specified value.
%
%   HSSF = dsp.SubbandSynthesisFilter(LPCOEFFS, HPCOEFFS, 'PropertyName',
%   PropertyValue, ...) returns a two-channel subband synthesis filter
%   System object, HSSF, with the LowpassCoefficients property set to
%   LPCOEFFS, the HighpassCoefficients property set to HPCOEFFS, and other
%   specified properties set to the specified values.
%
%   Step method syntax:
%
%   Y = step(HSSF, IN1, IN2) reconstructs a signal from the subband signals
%   IN1 and IN2.
%
%   SubbandSynthesisFilter methods:
%
%   step     - See above description for use of this method
%   release  - Allow property value and input characteristics changes
%   clone    - Create two-channel subband synthesis filter object with same
%              property values
%   isLocked - Locked status (logical)
%   reset    - Reset states of filter
%
%   SubbandSynthesisFilter properties:
%
%   LowpassCoefficients  - Lowpass FIR filter coefficients
%   HighpassCoefficients - Highpass FIR filter coefficients
%
%   This System object supports fixed-point operations. For more
%   information, type dsp.SubbandSynthesisFilter.helpFixedPoint.
%
...
%
%   See also dsp.SubbandAnalysisFilter,
%            dsp.DyadicSynthesisFilterBank,
%            dsp.SubbandSynthesisFilter.helpFixedPoint.

 
%   Copyright 1995-2013 The MathWorks, Inc.

    methods
        function out=SubbandSynthesisFilter
            %SubbandSynthesisFilter Reconstruct signal from high-frequency and low-
            %                       frequency subbands
            %   HSSF = dsp.SubbandSynthesisFilter returns a two-channel subband
            %   synthesis filter System object, HSSF, that reconstructs a signal from
        ...
        function helpFixedPoint(in) %#ok<MANU>
            %helpFixedPoint Display dsp.SubbandSynthesisFilter System
            %               object fixed-point information
            %   dsp.SubbandSynthesisFilter.helpFixedPoint displays information
            %   about fixed-point properties and operations of the
            %   dsp.SubbandSynthesisFilter System object.
        end
    ...
    properties
        ...
        %   Specify the accumulator fixed-point data type as one of [{'Full precision'} |
        %   'Same as product' | 'Same as input' | 'Custom']. This property is
        ...
        %   {'Floor'} | 'Nearest' | 'Round' | 'Zero']. This property is
        %   applicable when the object is not in a full precision
        %   configuration.
        RoundingMethod;
