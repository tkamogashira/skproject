classdef Maximum< handle
%Maximum Maximum values in an input or sequence of inputs
%   HMAX = dsp.Maximum returns a System object, HMAX, that computes the
%   value and/or index of the maximum elements in an input or a sequence of
%   inputs.
%
%   HMAX = dsp.Maximum('PropertyName', PropertyValue, ...) returns a
%   maximum System object, HMAX, with each specified property set to the
%   specified value.
%
%   Step method syntax:
%
%   [VAL, IND] = step(HMAX, X) computes maximum value, VAL, and the index
%   or position of the maximum value, IND, in each row or column of input
%   X, along vectors of a specified dimension of X, or of the entire input
%   X, depending on the value of the Dimension property.
%
...
%
%   IND = step(HMAX, X) returns the zero- or one-based index IND of the
%   maximum value when the IndexOutputPort property is true and the
%   ValueOutputPort property is false. The RunningMaximum property must be
%   false.
%
...
%   information, type dsp.Maximum.helpFixedPoint.
%
%   % EXAMPLE #1: Find maximum value and its index
%       hmax1 = dsp.Maximum;
%       x = randn(100,1);
%       [y, I] = step(hmax1, x);
%
%   % EXAMPLE #2: Compute running maximum
%       hmax2 = dsp.Maximum;
%       hmax2.RunningMaximum = true;
%       x = randn(100,1);
%       y = step(hmax2, x);    % Find running maximum
%       % y(i) is the maximum of all values in the vector x(1:i)
%
%   See also dsp.Minimum, dsp.Mean, 
%            dsp.Maximum.helpFixedPoint.
...
%   Copyright 2008-2013 The MathWorks, Inc.
    ...
    methods
        ...
        function helpFixedPoint(in) %#ok<MANU>
            %helpFixedPoint Display dsp.Maximum System object fixed-point 
            %               information
            %   dsp.Maximum.helpFixedPoint displays information about
            %   fixed-point properties and operations of the dsp.Maximum
            %   System object.
        end
    ...
    properties
        ...
        %   RunningMaximum property is true.
        FrameBasedProcessing;

        %IndexBase Numbering base for index of maximum value
        %   Specify the numbering base used when computing the index of the
        %   maximum value as one of [{'One'} | 'Zero']. This property is
