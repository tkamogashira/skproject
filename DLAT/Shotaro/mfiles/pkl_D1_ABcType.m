...
structplot(D1_ABcType_PHL,'CF','last_pkl',...
    D1_ABcType_PLN,'CF','last_pkl',...
    D1_ABcType_PL,'CF','last_pkl',...
    D1_ABcType_C,'CF','last_pkl',...
    D1_ABcType_O,'CF','last_pkl',...
    D1_ABcType_Oi,'CF','last_pkl',...
    D1_ABcType_OL,'CF','last_pkl',...
    D1_ABcType_Oc,'CF','last_pkl',...
    D1_ABcType_X,'CF','last_pkl',...
