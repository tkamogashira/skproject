...
% mwavesubtractPM(wave1, wave2, infoflag);
%
% ------------------------------------------------------------------
% Subtracts the signals in two 'wave's
%-------------------------------------------------------------------
% 
% Input parameters
...
%
% Example:
% to make a 500-Hz diotic tone and a 100-Hz diotic tone
% and then subtract the 100Hz from the 500Hz, type:
% >> wave1 = mcreatetone(500, 60, 60, 0, 0, 250, 10, 20000, 1);
% >> wave2 = mcreatetone(100, 60, 60, 0, 0, 250, 10, 20000, 1);
% >> wave3 = mwavesubtractPM(wave1, wave2, 1);
%
%
% ! steeds v/d vorm (x,y,1) : x - y
%
% version 1.0 (January 20th 2001)
% MAA Winter 2001 
% 
% mwaveadd functie aangepast voor mwavesubtract
% PM 28/09/06
%--------------------------------
