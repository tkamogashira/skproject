...
% TF 02/09/2005
% 
% Split cat and monkey data into two seperate m-files.
% 10/10/2006 PM
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 15                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 30                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 35                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 42                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 54                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 64                       
D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
close all;                                                                                           
                                                                                                                                              
%Fiber 25                                                                                                                                     
List = GenWFList(struct([]), 'A0241', [70;71;73], [+1, -1], 'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');               
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 70                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -45, subseq 2
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -46, subseq 4                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -49, subseq 3                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -50, subseq 3                      

D = [D; concatto1Row(ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm),'xval','yval','lag','normco','ppnormmagn','spnormmagn','spdelay')];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;close all;
% interaural correlation -1
List = struct('filename','A0241','iseqp',num2cell([-51,-51,-51,-51]),'isubseqp',num2cell([1,2,3,4]),...
    'iseqn',NaN,'isubseqn',NaN,'discernvalue',num2cell([50,60,70,80]));
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -51, subseq 3                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 87                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 95                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -66, subseq 2                      
...
List = struct('filename','A0241','iseqp',num2cell([-67,-67,-67,-67]),'isubseqp',num2cell([1,2,3,4]),...
    'iseqn',NaN,'isubseqn',NaN,'discernvalue',num2cell([50,60,70,80]));
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -67, subseq 3                      

D = [D; concatto1Row(ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm),'xval','yval','lag','normco','ppnormmagn','spnormmagn','spdelay')];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;close all;

%Fiber 42                                                                                                                                     
List = GenWFList(struct([]), 'A0241', [114;115;116], [+1, -1], 'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');            
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 114                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 128                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -78/-79, subseq 3                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds -82/-83, subseq 3                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 179                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 195                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 198                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 208                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = 215                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 217                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 229                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 232                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 260                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 263                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 267                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 2                        
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 9                        
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 15                      
...
List = struct('filename','A0242','iseqp',num2cell([20,21]),'isubseqp',num2cell([1,1]),...
    'iseqn',NaN,'isubseqn',NaN,'discernvalue',num2cell([70,60]));
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 20                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 23                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 30                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 34                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 40                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 44                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 50                       
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 58                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 83                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 88                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 93                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 97                       
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 106                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 113                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 120                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 129                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 134                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 137                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 142                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 155                      
...
List = struct('filename','A0242','iseqp',num2cell([185,186]),'isubseqp',num2cell([1,1]),...
    'iseqn',NaN,'isubseqn',NaN,'discernvalue',num2cell([70,60]));
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 185                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 191                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 202                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 211                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 234                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 241                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 280                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 318                      

D = [D; concatto1Row(ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm),'xval','yval','lag','normco','ppnormmagn','spnormmagn','spdelay')];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;close all;                                                                                           
                                                                                                                                              
%Fiber 82                                                                                                                                     
List = GenWFList(struct([]), 'A0242', [336;337], [+1, -1], 'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');                
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 336                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 343                      
...
T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 358                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 364                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 369                      
...
T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 378                      
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 66                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 79                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 159                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 218                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 239                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%  
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 275                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
% end                 
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 279                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 313                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 368                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 375                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 393                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 408                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 468                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 479                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 484                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 487                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 492                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 497                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 501                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 505                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 508                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 515                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;
% 
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 519                      
% 
% D = [D; concatto1Row(ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm),'xval','yval','lag','normco','ppnormmagn','spnormmagn','spdelay')];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;
% 
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 530                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 537                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 541                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 545                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 548                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 555                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 560                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 565                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 571                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 574                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 582                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 586                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
% 
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 13                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 17                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 37                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 47                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;
% 
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 63                      
% 
% D = [D; concatto1Row(ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm),'xval','yval','lag','normco','ppnormmagn','spnormmagn','spdelay')];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;
% 
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 93                       
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
% end
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 104                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 109                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 116                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 131                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 140                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 150                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
% 
...
% T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 155                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
% end
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 163                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 173                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 198                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 203                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 221                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 231                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 234                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
% T = genwfplotTF(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no','smoothing',smoothing,'spline',spline); % reference = ds 248                      
% 
% D = [D; ExtractPSentryTF(T, XFieldName, YFieldName, lagfn, normcofn, ppnm, spd, spnm)];groupplot(D(numel(D)),'xval','yval','xlim',[30 90],'ylim',[-0.4 0.4]);%pause;
% close all;                                                                                           
%                                                                                                                                               
...
%-----------------------------------------------------------------
DLATCAT = D; clear('D');
save('psLATcatPM', 'DLATCAT');
%-----------------------------------------------------------------

Ddif=structfilter(DLATCAT, '$difcor$ == 1');
Dnodif=structfilter(DLATCAT, '$difcor$ == 0');
