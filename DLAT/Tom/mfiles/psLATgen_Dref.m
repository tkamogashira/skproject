...
% PXJ 8/2005
%
% this version uses different reference spls for a particular fibre
% TF 26/08/2005
...
%% ref-nummer bepaald door rdoor rangnummer als spl-waarden van hoog naar laag schikken
...
List = GenWFList(struct([]), 'A0454', [17; 18; 19; 21], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 1, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); % reference = ds 17
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];
...
List = GenWFList(struct([]), 'A0454', [17; 18; 19; 21], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); % reference = ds 17
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];

% unit 6 ref 30
List = GenWFList(struct([]), 'A0454', [17; 18; 19; 21], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 4, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); % reference = ds 17
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];
...
List = GenWFList(struct([]), 'A0454', [47; 48; 49; 50; 51], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 2, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); 
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];

% unit 13 ref 70
List = GenWFList(struct([]), 'A0454', [47; 48; 49; 50; 51], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 3, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); 
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];

% unit 13 ref 60
List = GenWFList(struct([]), 'A0454', [47; 48; 49; 50; 51], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 4, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); 
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];

% unit 13 ref 55
List = GenWFList(struct([]), 'A0454', [47; 48; 49; 50; 51], [+1, -1], ... 
           'discernvalue', 'getfield(dataset($filename$, $iseqp$), ''spl'')');
T = GenWFPlot(List, 5, 'discernfieldlabel', 'Intensity', 'discernfieldunit', 'dB SPL','plot','no'); 
D = [D; ExtractPSentry(T, XFieldName, YFieldName)];
