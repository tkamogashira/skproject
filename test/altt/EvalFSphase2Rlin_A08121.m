function [BF,BestITD,BP,CD,CP,CF1,CF2,IPCx,IPCy,ISRx,ISRy,IPC,IRA] = EvalFSphase2Rlin_A08121(varargin)
...
IRA.Max = max(IRA.Y(:));
%Added by Shotaro
IRA.eachMax = max((cat(1, BinCycleHist.Y))');
...
if ~strncmp(ds1.FileName, ds2.FileName, 6), error('Datasets are from different experiment.'); end
