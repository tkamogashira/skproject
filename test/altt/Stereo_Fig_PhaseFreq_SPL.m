...
axis([0 4000 0 1]);
title('70dB');xlabel('Tone frequency (Hz)');ylabel('Interaural SyncRate');
hold off;
...
axis([0 4000 0 1]);
title('60dB');xlabel('Tone frequency (Hz)');ylabel('Interaural SyncRate');
hold off;
...
axis([0 4000 0 1]);
title('50dB');xlabel('Tone frequency (Hz)');ylabel('Interaural SyncRate');
hold off;
...
axis([0 4000 0 1]);
title('40dB');xlabel('Tone frequency (Hz)');ylabel('Interaural SyncRate');
hold off;
...
axis([0 4000 0 1]);
title('30dB');xlabel('Tone frequency (Hz)');ylabel('Interaural SyncRate');
hold off;
