function [ArgOut,ThrCF,DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD,CalcData] = EvalBB2(varargin)
...
if strcmpi(Param.plot, 'yes'), 
    if strcmpi(Param.plottype, 'all'),
        [DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD]=PlotCurve('cc', CalcData, CellInfo, Param); 
        [DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD]=PlotCurve('vs', CalcData, CellInfo, Param); 
    elseif strcmpi(Param.plottype, 'cc'), [DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD]=PlotCurve('cc', CalcData, CellInfo, Param); 
    else, [DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD]=PlotCurve('vs', CalcData, CellInfo, Param); end
end
...
%---------------------------------------------------------------------------------------------
function [DomF,RateBF,sigpX,sigpY,lineX,lineY,CD,CP,BestITD]=PlotCurve(Type, CalcData, CellInfo, Param)
...
if strcmpi(Type, 'cc'), %Superimpose, composite curve and spectrum ...
    ...
    %extract
    BestITD=CalcData.itd.bestitd;
    assignin('base','BestITD',BestITD);
    %extract
