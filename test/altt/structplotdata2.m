function [Info, Slope, Yintercept] = structplotdata2(varargin)
...
%Create scatterplot ...
[Info, Slope, Yintercept] = PlotTable(T, XFields, YFields, Param);
...
%-----------------------------------------------------------------------------
function [Info, Slope, Yintercept] = PlotTable(T, XFields, YFields, Param)
