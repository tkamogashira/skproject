...
for k=1:20
    ...
    for m=1:SIZE(2)
        ...
        if (CFcombiselectALL_50(m).CF2>=(k-1)*200)&(CFcombiselectALL_50(m).CF2<k*200)
            ...
            if CFcombiselectALL_50(m).pLinReg < 0.005
                plot(x,y,'b');hold on;
            elseif CFcombiselectALL_50(m).pLinReg >= 0.005
                plot(x,y,'r');hold on;    
            end;
...
for k=1:20
    ...
    for m=1:SIZE(2)
        ...
        if (CFcombiselectALL_50(m).CF2>=(k-1)*200)&(CFcombiselectALL_50(m).CF2<k*200)
            ...
            if CFcombiselectALL_50(m).pLinReg < 0.005
                plot(CFcombiselectALL_50(m).coch, CFcombiselectALL_50(m).CD, 'k.','markersize',6);hold on;
            elseif CFcombiselectALL_50(m).pLinReg >= 0.005
                plot(CFcombiselectALL_50(m).coch, CFcombiselectALL_50(m).CD, 'ko','markersize',6);hold on;
            end;
        end;
