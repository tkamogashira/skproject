...
grid on;
xlim([0 1100]);
title('uÅ®i');xlabel('(ms)');ylabel('(a.u.)');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% grid on;
% ylim([-10 10]);xlim([0 1100]);
% title('ç∂ì˚ìÀïî');xlabel('(ms)');ylabel('(microV)');
% 
% subplot(3,1,2)
% plot(time,aa22,'r');hold on;
% grid on;
% ylim([-10 10]);xlim([0 1100]);
% title('âEì˚ìÀïî');xlabel('(ms)');ylabel('(microV)');
% 
% subplot(3,1,3)
% plot(time,aaoto,'k');
% grid on;
% xlim([0 1100]);
% title('aÅ®a');ylim([-300 300]);xlabel('(ms)');ylabel('(a.u.)');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% figure
% time=ao(:,1);
...
% grid on;
% xlim([0 1100]);
% title('aÅ®o');ylim([-300 300]);xlabel('(ms)');ylabel('(a.u.)');
