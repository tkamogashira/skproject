% MNtoEachChEachF0001_2_102
function SigChN=MNtoEachChEachF0001_2_102(M,N,V,FA)
P((1:90),103)=(FA)';
for C=1:102
    for f=1:90
        if mean(M(C,f,(1:30)))-mean(N(C,f,(1:30)))<0
            P(f,C)=1;
        else
            [H,P(f,C),ci]=ttest2(M(C,f,(1:30)),N(C,f,(1:30)),0.001,0);
        end;
    end;
end;
for Fp=1:90
