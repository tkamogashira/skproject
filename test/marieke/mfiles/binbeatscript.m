%All data: binaural beat data and timewarped monaural data
%No data excluded
%No subdivision high spontaneous rate(HSR)-low spontaneous rate(LSR)
%No correction analysis window

%After binbeatscript.m run figbinbeatscript.m
...
[RinTmp, RmonTmp, RbinTmp] = BinBeat(P, dsIpsi, IpsiFreq, dsContra, ContraFreq, dsSpon, SponFreq);
Rin  = [Rin; RinTmp];
Rmon = [Rmon; RmonTmp];
Rbin = [Rbin; RbinTmp];
