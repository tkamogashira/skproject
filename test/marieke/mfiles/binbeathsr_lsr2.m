...
%Subdivision HSR-LSR
%if Rin=0 -> data excluded
%if Rmon=0 -> data excluded
%correction for analysis window in ms
    %[2 25]
    %[100 1000]
    %[100 5000]

%After binbeathsr_lsr2.m run figbinonset.m or figbinbeathsr_lsr2.m
...
%Timewarped data HSR
%P.anwin    = [2 25];   %Analysis window in ms ...
...
%P.anwin    = [100 1000];    %Analysis window in ms ...
