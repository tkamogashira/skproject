function ComData = datasetcom3(varargin);
...
for p=1:size(N,2)
    [ArgOut,BF,BP,CD,CP,CF1,CF2,IPCx,IPCy,IRx,IRy]=EvalFSphase(varargin{N(1,p)},varargin{N(2,p)}, 'plotmode', 'ALL');
    ...
    MeanCF=(CF1*CF2)^0.5;
    ComData(p)=struct('Fiber1',Fiber1,'Fiber2',Fiber2,'BF',BF,'BP',BP,'CD',CD,'CP',CP,...
        'CF1',CF1,'CF2',CF2,'DeltaCF',DeltaCF,'MeanCF',MeanCF,'ds1',ds1,...
        'IPCx',IPCx,'IPCy',IPCy,'IRx',IRx,'IRy',IRy);
    close all;
end;
