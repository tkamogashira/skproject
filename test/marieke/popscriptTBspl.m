...
T = EvalNRHO(ds);T.ds1.icell=2;T.ds1.seqid='2-15-SPL';
ds.stim.StimParam
T.tag = input('Input Tag.');
close;
T.burstDur=ds.stim.StimParam.burstDur;
...
T = EvalNRHO(ds);T.ds1.icell=2;T.ds1.seqid='2-16-SPL';
ds.stim.StimParam
T.tag = input('Input Tag.');
close;
T.burstDur=ds.stim.StimParam.burstDur;
...
T = EvalNRHO(ds);T.ds1.icell=2;T.ds1.seqid='3-21-SPL';
ds.stim.StimParam
T.tag = input('Input Tag.');
close;
T.burstDur=ds.stim.StimParam.burstDur;
...
T = EvalNRHO(ds);T.ds1.icell=2;T.ds1.seqid='4-26-SPL';
ds.stim.StimParam
T.tag = input('Input Tag.');
close;
T.burstDur=ds.stim.StimParam.burstDur;
...
T ;
T.burst= EvalNRHO(ds);ds.stim.StimParam
T.tag = input('Input Tag.');
closeDur=ds.stim.StimParam.burstDur;
T.lowFreq=ds.stim.StimParam.lowFreq;
T.highFreq=ds.stim.StimParam.highFreq;
T.rho=ds.stim.StimParam.rho;
D = [D, T];
