for n=1:71
    name=['PSratio' num2str(n)];
    value=evalin('base',name);
    M=length(value);
    D1_ABcType(n).last_PSratio=value(M);
end;
...
structplot(D1_ABcType_PHL,'CF','last_PSratio',...
    D1_ABcType_PLN,'CF','last_PSratio',...
    D1_ABcType_PL,'CF','last_PSratio',...
    D1_ABcType_C,'CF','last_PSratio',...
    D1_ABcType_O,'CF','last_PSratio',...
    D1_ABcType_Oi,'CF','last_PSratio',...
    D1_ABcType_OL,'CF','last_PSratio',...
    D1_ABcType_Oc,'CF','last_PSratio',...
    D1_ABcType_X,'CF','last_PSratio',...
