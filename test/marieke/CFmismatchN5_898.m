%CFmismatch
function CFcombiselect = CFmismatchN5_898(varargin);
...
for q=1:N
    ...
    for p=1:(N-1)
        ...
        [BF,BestITD,BP,CD,CP,CF1,CF2,IPCx,IPCy,ISRx,ISRy]=EvalFSphase2Rnew(A(p+1),A(1), 'plotmode', 'ALL');
...
SIZE=size(CFcombiSelect);
disp(SIZE)
%assignin('base','CFcombiselectTest',CFcombiSelect);
