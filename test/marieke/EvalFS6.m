function [ArgOut,BF,BP,CD,CP,CF1,CF2] = EvalFS(varargin)
...
if CalcParam.corbinwidth==0
    ArgOut=[];BF=0;BP=0;CD=0;CP=0;CF1=0;CF2=0;return;
end
...
if isempty(ComSub)
    fprintf('No common subsequences.');ArgOut=[];BF=0;BP=0;CD=0;CP=0;CF1=0;CF2=0;return; 
elseif NSub == 1
    fprintf('Only one common subsequence.');ArgOut=[];BF=0;BP=0;CD=0;CP=0;CF1=0;CF2=0;return;
else
...
if strcmpi(PlotParam.plot, 'YES')
    if any(strcmpi(PlotParam.plotmode, {'ALL', 'CC'})) 
        ...
        [BF,BP] = PlotCC(CC, SI, CrossCor, FFT, CellInfo, Param);
    end
    if any(strcmpi(PlotParam.plotmode, {'ALL', 'IPC'}))
        ...
        [CD,CP,CF1,CF2] = PlotIPC(IPC, IR, BinCycleHist, CellInfo, Param);
    end
...
if CheckStimParam(ds1, ds2)
    ...
    DataFile=[];Cell1=[];Cell2=[];ds1=[];ds2=[];CalcParam.corbinwidth=0;PlotParam=[];ArgOut=[];BF=0;BP=0;CD=0;CP=0;CF1=0;CF2=0;return
end
...
% PLOTCC %
%--------%
function [BF,BP] = PlotCC(ComCurve, SuperImpose, CrossCor, FFT, CellInfo, Param)
...
%BF&BP assign
BF=FFT.DF;BP=ComCurve.BestITD*FFT.DF/1000;
assignin('base','BF',BF);assignin('base','BP',BP);
...
% PLOTIPC %
%---------%
function [CD,CP,CF1,CF2] = PlotIPC(IPC, IR, BinCycleHist, CellInfo, Param)
