...
subplot(3,1,1)
plot(time,ui11,'b');hold on;
grid on;
ylim([-10 10]);xlim([0 1100]);
title('¶“û“Ë•”');xlabel('(ms)');ylabel('(microV)');

subplot(3,1,2)
plot(time,ui22,'r');hold on;
grid on;
ylim([-10 10]);xlim([0 1100]);
...
grid on;
xlim([0 1100]);
title('u¨i');xlabel('(ms)');ylabel('(a.u.)');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
time=aa(:,1);
...
grid on;
xlim([0 1100]);
title('a¨a');ylim([-300 300]);xlabel('(ms)');ylabel('(a.u.)');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
time=ao(:,1);
...
grid on;
xlim([0 1100]);
title('a¨o');ylim([-300 300]);xlabel('(ms)');ylabel('(a.u.)');
