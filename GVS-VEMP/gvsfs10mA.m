...
rmsV=RMSmA/2 %アイソレータが10mA[10]0の場合　% rmsVがmaxVの1/10なら早くループから抜けられる
maxV=MAXmA/2 %アイソレータが10mA[10]0の場合
...
assignin('base','Fs',Fs);
L=round(Duration*Fs/2);PassBand=[1 1000];%Duration=3.5s.
