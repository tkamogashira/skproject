...
% 
% which formants
if isfield(options,'use_formants')
    use_formants=options.use_formants;
else
    use_formants=[1 2 3 4];
end
...
nr_formants=length(use_formants);


switch vowel
    case 'a';
        formfre_org(1)=730; formfre_org(2)=1090; formfre_org(3)=2440; formfre_org(4)=3300;% standard formant freqs       
    case 'e';
        formfre_org(1)=400; formfre_org(2)=1990; formfre_org(3)=2550; formfre_org(4)=3700; % standard formant freqs       
    case 'i';
        formfre_org(1)=270; formfre_org(2)=2260; formfre_org(3)=3000; formfre_org(4)=3700;% standard formant freqs     
    case 'o';
        formfre_org(1)=570; formfre_org(2)=850; formfre_org(3)=2430; formfre_org(4)=3300;% standard formant freqs
    case 'u';
        formfre_org(1)=300; formfre_org(2)=850; formfre_org(3)=2260; formfre_org(4)=3700;% standard formant freqs   
    otherwise
        error('signal::gen_vowel: dont know vowel');
end

for i=1:length(use_formants)
    formfre(i)=formfre_org(use_formants(i));
end
