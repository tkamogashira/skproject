...
% Last Modified by GUIDE v2.5 16-Dec-2002 17:31:17
...
NCond=NBand*NSPL*NDelay*NITD*NILD;
mySTIM=cell(NCond,8);
cnt=0;
for iBand=1:NBand %%%%%%%%
        ...
        for iDelay=1:NDelay %%%%
            ...
            for iITD=1:NITD %%%%%%
                ...
                for iILD=1:NILD %%%%%
                    ...
                    cnt=cnt+1;
                    mySTIM(cnt,:)={'CombNoise',num2str(myBand),num2str(FiltOrder), num2str(mySPL),num2str(myDelay),num2str(myITD),...
