...
% Last Modified by GUIDE v2.5 05-Mar-2003 19:16:01
...
if ~isempty(myh)
    ...
    Setting.IPDRange=get(myhandles.edit_ipdrange,'String');
    Setting.Period=get(myhandles.edit_period,'String');
...
% --------------------------------------------------------------------
function varargout = edit_centeripd_Callback(h, eventdata, handles, varargin)
