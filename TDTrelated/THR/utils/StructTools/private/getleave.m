...
if ~iscellstr(varargin), error('Additional arguments should be names of fields to retrieve from structure-array.'); end

[C, F] = destruct(S);
if ~all(ismember(varargin, F)), error('One of the requested fieldnames doesn''t exist.'); end
