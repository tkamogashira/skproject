...
@Embeddable
public class KQuestSubSeqPK implements Serializable {
    ...
    public KQuestSubSeqPK() {
    }

    public KQuestSubSeqPK(final String fileName, final Integer iSeq,
    ...
    public boolean equals(final Object object) {
        ...
        if (!(object instanceof KQuestSubSeqPK)) {
            return false;
        }
        KQuestSubSeqPK other = (KQuestSubSeqPK) object;
    ...
    public String toString() {
        return "KQuest.KQuestSubSeqPK[fileName=" + fileName + ", iSeq=" + iSeq + ", subSeqNr=" + subSeqNr + "]";
    }
}
