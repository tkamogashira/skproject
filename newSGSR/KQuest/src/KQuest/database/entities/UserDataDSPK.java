...
@Embeddable
public class UserDataDSPK implements Serializable {
    ...
    public UserDataDSPK(final String fileName, final Integer iSeq) {
    ...
    public boolean equals(final Object object) {
        ...
        if (!(object instanceof UserDataDSPK)) {
            return false;
        }
        UserDataDSPK other = (UserDataDSPK) object;
    ...
    public String toString() {
        return "KQuest.UserDataDSPK[fileName=" + fileName + ", iSeq=" + iSeq + "]";
    }
