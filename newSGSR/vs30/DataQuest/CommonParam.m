...
if all(isnan(S.Common.Tone.ModFreq)), S.Common.Tone.ModDepth = NaN; %Modulation depth in percent ...
else, S.Common.Tone.ModDepth = ExtractModDepth(ds); end
