function ArgOut = GenWFPlot(varargin)
%GENWFPLOT  generate waterfall plot.
...
List = structsort(List, Props.discernfieldname, 'mode', 'desc'); % BUG
...
if strcmpi(Props.cortype, 'across'),
    ...
    if strcmpi(Props.refautocor, 'yes'),
        ...
        [NrOfCo(RefRow, :), NormCo(RefRow, :), CorType{n}] = ...
...
[MagnAtZero, MagnAtZeroNorm] = deal(zeros(N, 1)); idxZero = find(Lag == 0);
for n = 1:N,
