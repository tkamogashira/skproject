...
%   SYS3READ(Tag, Dev, N, Offset) returns as a vector containing N samples from a buffer   
%   named Tag on device Dev. Offset is the zero-based position in the buffer 
%   where reading is started, it defaults to zero.  
