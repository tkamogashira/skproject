function [Mean, Std] = sys3DacDelay(Nevents, reqPulsePer, reqSrate, Dev);  
  
%  SYS3DACDELAY - get mean DACdelay on the RP2_1 and its standard deviation  
%  
...
%                               When Dev = 1, RP2_1 and RV8_1 are used  ,
%                               when Dev = 2, RP2_2 and RV8_2 are used.
%
...
end;                                                %% trhrow out non-increasing timestaps  
