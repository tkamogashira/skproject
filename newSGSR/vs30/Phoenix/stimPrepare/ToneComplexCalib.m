function [Amp, Phase, maxSPL] = ToneComplexCalib(Amp, Phase, CalibParams, maxSampleMag, ampWeight);
% ToneComplexCalib - sample amplitudes and attenuator settings for tone complexes
%   [Amp, Phase, MaxSPL, Atten] = ToneComplexCalib(Amp, Phase, CP, maxMagSample) 
...
%   Usually, CP is of the form {freq, ifilt, chan}, but context parameters may be
%   appended. See Calibrate.
...
%         analog attenuation.
%
%   ToneComplexCalib(Amp, Phase, CP, maxMagSample, ampWeight) uses ampWeight.*Amp
