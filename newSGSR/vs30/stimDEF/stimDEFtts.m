function SD = stimDEFtts(SMS);

% stimDEFtts(SMS) - analyze multiplicities of SMStts params
...
BufVar = prepareTTSstim(SMS.StimParam);
TTSparam = SMS.StimParam;
...
for isubs=1:Nsubseq,
   ...
   if makeLeft,
      ...
      SD.waveform{Nwf}.stimpar = CollectInstruct(isubs, TTSparam);
