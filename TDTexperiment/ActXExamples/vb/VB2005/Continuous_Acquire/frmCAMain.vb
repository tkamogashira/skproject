...
Public Class frmCAMain

    Const Circuit = "C:\TDT\ActiveX\ActXExamples\RP_files\Continuous_Acquire.rcx"
    Const BufferSize = 100000   'size of serial buffer

    Dim fStream As New FileStream("C:\TDT\ActiveX\ActXExamples\vb\VB2005\tones.dat", FileMode.OpenOrCreate)
    Dim fWriter As BinaryWriter

    Dim i As Integer
    Dim data(,) As Single       'buffer for saving data
