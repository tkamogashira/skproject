...
% Last Modified by GUIDE v2.5 11-Mar-2003 10:26:08
...
for iSPL=1:NSPL %%%%%%%%
    ...
    for iFreq=1:NFreq %%%%%%%%
        ...
        %Adjust by threshold
        if Setting.SLFlag
            mymySPL=mySPL+GerbilThreshSPL(myFreq);
        else
            mymySPL=mySPL;
        end
        ...
        for iITD=1:NITD %%%%%%
            ...
            for iILD=1:NILD %%%%%
                ...
                cnt=cnt+1;
                mySTIM(cnt,:)={'Tone',num2str([myFreq DF]),num2str(mymySPL),num2str(myITD),num2str(FixEnvFlag),...
