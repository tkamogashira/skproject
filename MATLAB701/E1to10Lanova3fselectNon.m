% E1to10Lanova3fselectNon
function H4L=E1to10Lanova3fselectNon(S1,S2,S3,S4,S5,S6,S7,S8,S9,M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9,V)
...
for f=1:123
    ...
    pf=anovan(sheet(:,4),{sheet(:,1) sheet(:,2) sheet(:,3)},'display','off','alpha',0.01,'model','interaction');
    Ptable(f,(1:6))=(pf)';
    clear pf;
    clear sheet;
    clear X;
