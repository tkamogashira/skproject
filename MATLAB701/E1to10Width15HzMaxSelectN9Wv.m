% E1to10Width15HzMaxSelectN9Wv
function M1S=E1to10Width15HzMaxSelectN9Wv(M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9)
M1S((1:123),203)=M1((15:137),203);
for n=1:202
    for f=15:137
        if M1(f,n)==max(M1(((f-10):(f+10)),n))
            M1S((f-14),n)=M1(f,n);
        else
            M1S((f-14),n)=0;
        end
