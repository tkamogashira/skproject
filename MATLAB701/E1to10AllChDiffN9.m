% E1to10AllChDiffN9
function SelectChN1=E1to10AllChDiffN9(M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9)
...
for F=1:123
    SelectAmp1(F,1)=mean([D1S(F,1),D1S(F,(3:177)),D1S(F,(179:202))]);
    SelectAmp2(F,1)=mean([D2S(F,1),D2S(F,(3:177)),D2S(F,(179:202))]);
    SelectAmp3(F,1)=mean([D3S(F,1),D3S(F,(3:177)),D3S(F,(179:202))]);
    SelectAmp4(F,1)=mean([D4S(F,1),D4S(F,(3:177)),D4S(F,(179:202))]);
    SelectAmp5(F,1)=mean([D5S(F,1),D5S(F,(3:177)),D5S(F,(179:202))]);
    SelectAmp6(F,1)=mean([D6S(F,1),D6S(F,(3:177)),D6S(F,(179:202))]);
    SelectAmp7(F,1)=mean([D7S(F,1),D7S(F,(3:177)),D7S(F,(179:202))]);
    SelectAmp8(F,1)=mean([D8S(F,1),D8S(F,(3:177)),D8S(F,(179:202))]);
    SelectAmp9(F,1)=mean([D9S(F,1),D9S(F,(3:177)),D9S(F,(179:202))]);
    SelectChN1(F,1)=nnz([D1S(F,1),D1S(F,(3:177)),D1S(F,(179:202))]);
end;
