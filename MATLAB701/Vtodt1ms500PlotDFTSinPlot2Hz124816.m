% V to dt1ms500PlotDFTSinPlot2Hz124816
function Vtodt1ms500PlotDFTSinPlot2Hz124816(V)
FFT=fft(V);
...
y8=(real(RFFT(8))*cos(2*pi*FreqAxis(8)*T)-imag(RFFT(8))*sin(2*pi*FreqAxis(8)*T))/250;
y16=(real(RFFT(16))*cos(2*pi*FreqAxis(16)*T)-imag(RFFT(16))*sin(2*pi*FreqAxis(16)*T))/250;
