...
function SigChN=E1to10AllChDiffN10fInt005vsNEW(M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,V)
for c=1:202
...
for C=1:202
    for fp=8:116
        if mean([(sum(M1S(((fp-7):(fp+7)),C))-sum(N1S(((fp-7):(fp+7)),C))) (sum(M2S(((fp-7):(fp+7)),C))-sum(N2S(((fp-7):(fp+7)),C))) (sum(M3S(((fp-7):(fp+7)),C))-sum(N3S(((fp-7):(fp+7)),C))) (sum(M4S(((fp-7):(fp+7)),C))-sum(N4S(((fp-7):(fp+7)),C))) (sum(M5S(((fp-7):(fp+7)),C))-sum(N5S(((fp-7):(fp+7)),C))) (sum(M6S(((fp-7):(fp+7)),C))-sum(N6S(((fp-7):(fp+7)),C))) (sum(M7S(((fp-7):(fp+7)),C))-sum(N7S(((fp-7):(fp+7)),C))) (sum(M8S(((fp-7):(fp+7)),C))-sum(N8S(((fp-7):(fp+7)),C))) (sum(M9S(((fp-7):(fp+7)),C))-sum(N9S(((fp-7):(fp+7)),C))) (sum(M10S(((fp-7):(fp+7)),C))-sum(N10S(((fp-7):(fp+7)),C)))])<0
            ...
            [H,P(fp,C),ci]=ttest([(sum(M1S(((fp-7):(fp+7)),C))-sum(N1S(((fp-7):(fp+7)),C))) (sum(M2S(((fp-7):(fp+7)),C))-sum(N2S(((fp-7):(fp+7)),C))) (sum(M3S(((fp-7):(fp+7)),C))-sum(N3S(((fp-7):(fp+7)),C))) (sum(M4S(((fp-7):(fp+7)),C))-sum(N4S(((fp-7):(fp+7)),C))) (sum(M5S(((fp-7):(fp+7)),C))-sum(N5S(((fp-7):(fp+7)),C))) (sum(M6S(((fp-7):(fp+7)),C))-sum(N6S(((fp-7):(fp+7)),C))) (sum(M7S(((fp-7):(fp+7)),C))-sum(N7S(((fp-7):(fp+7)),C))) (sum(M8S(((fp-7):(fp+7)),C))-sum(N8S(((fp-7):(fp+7)),C))) (sum(M9S(((fp-7):(fp+7)),C))-sum(N9S(((fp-7):(fp+7)),C))) (sum(M10S(((fp-7):(fp+7)),C))-sum(N10S(((fp-7):(fp+7)),C)))],0,0.05,0);
        end;
    end;
end;
