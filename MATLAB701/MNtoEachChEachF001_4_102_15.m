% MNtoEachChEachF001_4_102_15
function SigChN=MNtoEachChEachF001_4_102_15(M,N,V,FA)
P((1:90),103)=(FA)';
...
for C=1:102
    for g=5:85
        if mean(mean(M(C,((g-4):(g+5)),(1:15)),2))-mean(mean(N(C,((g-4):(g+5)),(1:15)),2))<0
            ...
            [H,P(g,C),ci]=ttest2(mean(M(C,((g-4):(g+5)),(1:15)),2),mean(N(C,((g-4):(g+5)),(1:15)),2),0.01,0);
        end;
    end;
end;
for Fp=1:90
