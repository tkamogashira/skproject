% E1to10Allttestnon
function frequency=E1to10Allttestnon(S,M,N,V)
...
for f=1:123
    if (mean(Sn(f,(1:202)))>mean(Mn(f,(1:202))))&(mean(Sn(f,(1:202)))>mean(Nn(f,(1:202))))
        H4(f,1)=ttest(Sn(f,(1:202)),Mn(f,(1:202)),0.01)*ttest(Sn(f,(1:202)),Nn(f,(1:202)),0.01);
    else
        H4(f,1)=0;
    end;
end;
...
for f=1:123
    if (mean(Mn(f,(1:202)))>mean(Sn(f,(1:202))))&(mean(Mn(f,(1:202)))>mean(Nn(f,(1:202))))
        H6(f,1)=ttest(Mn(f,(1:202)),Sn(f,(1:202)),0.01)*ttest(Mn(f,(1:202)),Nn(f,(1:202)),0.01);
    else
        H6(f,1)=0;
    end;
end;
