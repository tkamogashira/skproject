...
for F=1:123
    SelectAmp1(F,1)=mean([D1S(F,1),D1S(F,find(V(2,(3:202))>0))]);
    SelectAmp2(F,1)=mean([D2S(F,1),D2S(F,find(V(2,(3:202))>0))]);
    SelectAmp3(F,1)=mean([D3S(F,1),D3S(F,find(V(2,(3:202))>0))]);
    SelectAmp4(F,1)=mean([D4S(F,1),D4S(F,find(V(2,(3:202))>0))]);
    SelectAmp5(F,1)=mean([D5S(F,1),D5S(F,find(V(2,(3:202))>0))]);
    SelectAmp6(F,1)=mean([D6S(F,1),D6S(F,find(V(2,(3:202))>0))]);
    SelectAmp7(F,1)=mean([D7S(F,1),D7S(F,find(V(2,(3:202))>0))]);
    SelectAmp8(F,1)=mean([D8S(F,1),D8S(F,find(V(2,(3:202))>0))]);
    SelectAmp9(F,1)=mean([D9S(F,1),D9S(F,find(V(2,(3:202))>0))]);
    SelectChN1(F,1)=nnz([D1S(F,1),D1S(F,find(V(2,(3:202))>0))]);
end;
