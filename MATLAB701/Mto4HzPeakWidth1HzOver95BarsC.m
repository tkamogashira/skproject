% M to 4HzPeakWidth1HzOver95BarsC
function ChMXY=Mto4HzPeakWidth1HzOver95BarsC(M,V,C)
ChPlusData=[M;V];
ChMXY(1,:)=C(1,:);
ChMXY(2,:)=C(2,:);
ChMXY(3,:)=V(1:202);
hold off;
for n=1:202
    if ChPlusData(55,n)>mean(ChPlusData((49:62),n))+std(ChPlusData((49:62),n))*1.64
    ...
    elseif ChPlusData(56,n)>mean(ChPlusData((49:62),n))+std(ChPlusData((49:62),n))*1.64 
