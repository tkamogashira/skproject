% E1to10over95ChNumberLCR666new
function NumberTvsRev=E1to10over95ChNumberLCR666new(M4,M6,N,V)
...
assignin('base',[inputname(1) '_SelectChs95new666'],SelectChs);
assignin('base',[inputname(1) '_NumberLCR95new666'],NumberLCR);
NumberLCRrev=[nnz(SelectChs_rev(2,:)==1) nnz(SelectChs_rev(2,:)==0) nnz(SelectChs_rev(2,:)==2)];
assignin('base',[inputname(1) '_SelectChs95new666_rev'],SelectChs_rev);
assignin('base',[inputname(1) '_NumberLCR95new666_rev'],NumberLCRrev);
