% V to dt1ms250PlotDFTSinPlot4Hz124816
function Vtodt1ms250PlotDFTSinPlot4Hz124816(V)
FFT=fft(V);
...
y16=(real(RFFT(16))*cos(2*pi*FreqAxis(16)*T)-imag(RFFT(16))*sin(2*pi*FreqAxis(16)*T))/125;
