...
if DirectionSum(1,1)*Direction(1,2)<0
...
if DirectionSum(1,2)*Direction(1,3)<0
...
if DirectionSum(1,3)*Direction(1,4)<0
...
if DirectionSum(1,4)*Direction(1,5)<0
...
for m=6:Z
    ...
    if DirectionSum(1,(m-1))*Direction(1,m)<0
        Reverse(1,m)=1;
    else
        Reverse(1,m)=0;
    end;
