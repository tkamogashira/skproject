% V to FFTPowerPhasePlot12468
function VtoFFTPowerPhasePlot12468(V)
FFT=fft(V);
FFT(1)=[];
...
semilogy(Phase(1),Power(1),'r+',(Phase(1)-2),Power(1),'r+',(Phase(1)+2),Power(1),'r+',...
    ...
    Phase(6),Power(6),'rd',(Phase(6)-2),Power(6),'rd',(Phase(6)+2),Power(6),'rd',...
    Phase(8),Power(8),'rp',(Phase(8)-2),Power(8),'rp',(Phase(8)+2),Power(8),'rp'),grid
axis([-1 1 0 100000])
