% E1to10AllChDiffN9fInt005vV3z
function P=E1to10AllChDiffN9fInt005vV3z(M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9,V)
...
for fp=1:123
    ...
    if sum([Mid1 Mid2 Mid3 Mid4 Mid5 Mid6 Mid7 Mid8 Mid9])<0
        ...
        [H,P(fp,2),ci]=ttest([Mid1 Mid2 Mid3 Mid4 Mid5 Mid6 Mid7 Mid8 Mid9],0,0.05,0);
    end;
    ...
    if sum([Lt1 Lt2 Lt3 Lt4 Lt5 Lt6 Lt7 Lt8 Lt9])<0
        ...
        [H,P(fp,1),ci]=ttest([Lt1 Lt2 Lt3 Lt4 Lt5 Lt6 Lt7 Lt8 Lt9],0,0.05,0);
    end;
    ...
    if sum([Rt1 Rt2 Rt3 Rt4 Rt5 Rt6 Rt7 Rt8 Rt9])<0
        ...
        [H,P(fp,3),ci]=ttest([Rt1 Rt2 Rt3 Rt4 Rt5 Rt6 Rt7 Rt8 Rt9],0,0.05,0);
    end;
end;
assignin('base','P',P);
