% BB_PESTwith3AFC4
function RESULT=BB_PESTwith3AFC4(F0,F1,W1,Z,p)
t=(1:(1/8192):3.5);
...
for m=6:Z
    ...
    CandidateDirection=Direction(1,(1:m));
    Move=CandidateDirection(1,find(Direction(1,(1:m))));
    CandidateWidth=[Width(1,(1:(m-1))) 0];
    MoveWidth=CandidateWidth(1,find(Direction(1,(1:m))));
    CandidateReverse=Reverse(1,(1:m));
    MoveReverse=CandidateReverse(1,find(Direction(1,(1:m))));
    M=length(Move);
    if (Reverse(1,m)==0)&(Direction(1,m)==1)
        if (M>=5)&(MoveWidth(1,(M-3))~=2*MoveWidth(1,(M-4)))&(Move(1,(M-2))==1)&(Move(1,(M-1))==1)
            Width(1,m)=Width(1,(m-1))*2;
        elseif (M>2)&(M<5)&(Move(1,(M-2))==1)&(Move(1,(M-1))==1)
            Width(1,m)=Width(1,(m-1))*2;
        elseif (M>=6)&(MoveWidth(1,(M-4))==2*MoveWidth(1,(M-5)))&(MoveReverse(1,(M-4))==1)&(Move(1,(M-3))==1)&(Move(1,(M-2))==1)&(Move(1,(M-1))==1)
            Width(1,m)=Width(1,(m-1))*2;
        else
...
RESULT=[Tnumber(1,(1:Z));Freq(1,(1:Z));BBinterval(1,(1:Z));Ans(1,(1:Z));Judge(1,(1:Z));Tcurrent(1,(1:Z));C(1,(1:Z));X(1,(1:Z));Direction(1,(1:Z));DirectionSum(1,(1:Z));MoveRecord(1,(1:Z));Reverse(1,(1:Z));Width(1,(1:Z))];
