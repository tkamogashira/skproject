% E1to10AllChDiffN9fInt005vsNEW102
function SigChN=E1to10AllChDiffN9fInt005vsNEW102(M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9,V)
...
for C=1:100
    for fp=8:116
        if mean(mean(MM(((fp-7):(fp+7)),C,:),1),3)<mean(mean(NN(((fp-7):(fp+7)),C,:),1),3)
            ...
            [H,P(fp,C),ci]=ttest((mean(MM(((fp-7):(fp+7)),C,:),1)-mean(NN(((fp-7):(fp+7)),C,:),1)),0,0.05,0);
        end;
    end;
end;
