% E1to10over2SD_2
function H=E1to10over2SD_2(S,M,N,V)
...
for n=1:17
    Z(n,1)=sum(H(((7*n-3):(7*n+3)),1));
    Z(n,2)=sum(H(((7*n-3):(7*n+3)),2));
end;
assignin('base','Z',Z);
plot([1:1:17],Z(:,1),'b',[1:1:17],Z(:,2),'r'),axis([1 17 0 50]),grid on
end
