% E1to10over2SD_3
function H=E1to10over2SD_3(k,S,M,N,V)
...
for f=(k+1):(123-k)
    ...
    I2=(max(Mn(((f-k):(f+k)),L))-mean(Mn(((f-k):(f+k)),L),1)-std(Mn(((f-k):(f+k)),L),0,1)*2<=0);
    % search for 4HzBB amplitude that is larger than NoBB amplitude on the channel
    I3=(max(Nn(((f-k):(f+k)),L))-mean(Nn(((f-k):(f+k)),L),1)-std(Nn(((f-k):(f+k)),L),0,1)*2<=0);
    ...
    J2=(max(Sn(((f-k):(f+k)),L))-mean(Sn(((f-k):(f+k)),L),1)-std(Sn(((f-k):(f+k)),L),0,1)*2<=0);
    % search for 6.66HzBB amplitude that is larger than NoBB amplitude on the channel
    J3=(max(Nn(((f-k):(f+k)),L))-mean(Nn(((f-k):(f+k)),L),1)-std(Nn(((f-k):(f+k)),L),0,1)*2<=0);
