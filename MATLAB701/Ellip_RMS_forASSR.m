% Ellip_RMS_forASSR
function MeanRMS=Ellip_RMS_forASSR(M,N)
...
assignin('base',[inputname(1) '_EllipRMSdata'],RMSdata);
MeanRMS1=mean(RMSdata(2,(227:377)));
MeanRMS0=mean(RMSdata(3,(227:377)));
MeanRMS2=mean(RMSdata(4,(227:377)));
MeanRMS=[MeanRMS1 MeanRMS0 MeanRMS2];
assignin('base',[inputname(1) '_EllipMeanRMS'],MeanRMS);
