% SS to 4HzFFTSinePhaseCo 621points
function T1=SSto4HzFFTSinePhaseCo621(V)
% FFT of SS
FFT=fft(V);
A0=FFT(1);
FFT(1)=[];
...
y=(A0+real(RFFT(4))*cos(2*pi*FreqAxis(4)*T1)-imag(RFFT(4))*sin(2*pi*FreqAxis(4)*T1))/(621/2);
[Max,MaxPhaseI]=max(y);
