% E1to10Width1HzMaxSelectN9Wsum
function M1S=E1to10Width1HzMaxSelectN9Wsum(M1,M2,M3,M4,M5,M6,M7,M8,M9,N1,N2,N3,N4,N5,N6,N7,N8,N9)
...
for fp=1:123
    if sum(SelectAmpM1to9(fp,:))<sum(SelectAmpN1to9(fp,:))
        P(fp,1)=1;
    else
